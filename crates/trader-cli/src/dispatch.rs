...
pub fn load_strategy(strategy_id: &str, toml_str: &str) -> Result<LoadedStrategy> {
    match strategy_id {
        ...
        other => anyhow::bail!(
            "estratégia desconhecida: {other} (suportadas: pullback-trend-v1, failure-test-long-v1, breakout-first-pullback-v1, opening-reversal-v1, balance-area-breakout-v1, range-extreme-fade-v1, low2-m2s-short-v1)"
        ),
    }
}
